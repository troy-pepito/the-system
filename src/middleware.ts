...
export const config = {
  // Skip Next internals, the SW + manifest (so PWA assets keep being
  // served from whatever host requested them), and API routes.
  matcher: [
    "/((?!_next/static|_next/image|favicon.ico|sw.js|manifest.webmanifest|api/).*)",
  ],
};
